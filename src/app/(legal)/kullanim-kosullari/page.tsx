    ...
    <div data-theme="valentine">
      ...
      <div className="relative px-4 lg:max-w-5xl mx-auto my-3 mb-6 text-left space-y-5">
        ...
        <p>
          ...
          Şayet bu sözleşmede yazan herhangi bir koşul kabul etmiyorsanız,
        ...
        <p>
          Gönen Kleopatra olarak, sunacağımız hizmetlerin kapsamını ve
        ...
        <p>
          SİTE&apos;de yayınlanan tüm metin, kod, grafikler, logolar, resimler,
          ses dosyaları ve kullanılan yazılımın sahibi (bundan böyle ve daha
          sonra &quot;içerik&quot; olarak anılacaktır) Gönen Kleopatra olup, tüm
          hakları saklıdır. Yazılı izin olmaksızın site içeriğinin çoğaltılması
        ...
        <ul>
          ...
          <li>
            SİTE&apos;de mevcut bilgilerin doğruluk ve güncelliğini sağlamak
            için elimizden geleni yapmaktayız. Lakin gösterdiğimiz çabaya
          ...
          <li>
            ...
            önlemi almak, kullanıcıların sorumluluğundadır. Virüs vb. kötü
            amaçlı programlar, kodlar veya materyallerin sebep olabileceği
        ...
        <p>
          ...
          kast ve ağır ihmal ile sınırlıdır. Sözleşmenin ihlalinden doğan
          zararlarda, talep edilebilecek toplam tazminat, öngörülebilir hasarlar
          ile sınırlıdır. Yukarıda bahsedilen sorumluluk sınırlamaları aynı
          zamanda insan hayatına, bedeni yaralanmaya veya bir kişinin sağlığına
