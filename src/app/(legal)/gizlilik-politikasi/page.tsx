...
export default function PrivacyPolicy() {
  return (
    <div data-theme="valentine">
      ...
      <div className="max-w-5xl mx-auto my-3 mb-10 text-left space-y-5">
        ...
        <p>
          Biz, Gönen Kleopatra olarak veri sorumlusu sıfatıyla, bu gizlilik ve
          kişisel verilerin korunması politikası ile, hangi kişisel
          verilerinizin hangi amaçla işleneceği, işlenen verilerin kimlerle ve
          neden paylaşılabileceği, veri işleme yöntemimiz ve hukuki sebeplerimiz
          ile; işlenen verilerinize ilişkin haklarınızın neler olduğu konusunda
        ...
        <div className="space-y-2">
          ...
          <ul>
            ...
            gördüyseniz zararnın giderilmesini talep etme. Yukarıdaki
            haklarınızı kullanmak için bize
            <a
              href="mailto:gonenkleopatra@gmail.com"
              className="text-[#b64983]"
            >
              {" "}
              gonenkleopatra@gmail.com{" "}
            </a>
        ...
        <p>
          ...
          <a href="mailto:gonenkleopatra@gmail.com" className="text-[#b64983]">
            {" "}
            gonenkleopatra@gmail.com{" "}
          </a>
