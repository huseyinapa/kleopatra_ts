      ...
      <div className="w-[100%]">
        ...
        {loading ? (
          ...
          <div className="px-5 justify-center py-8 space-y-4">
            ...
            />
            <div
              className={`flex ${currentStep === 3 ? "justify-center" : ""}`}
            >
              <div>
                {currentStep === 0 && (
                  <CartProduct
        ...
        <dialog id="distance_selling_contract" className="modal">
          <div className="modal-box">
            ...
            <div className="py-4 space-y-3">
              ...
              <div>
                İşbu sözleşmenin konusu, TÜKETİCİ&apos;nin
                www.gonenkleopatra.com internet sitesinden elektronik ortamda
                siparişini yaptığı aşağıda nitelikleri ve satış fiyatı
                belirtilen ürünün satışı ve teslimi ile ilgili olarak 6502
                sayılı Tüketicinin Korunması Hakkındaki Kanun hükümleri
                gereğince tarafların hak ve yükümlülüklerinin saptanmasıdır.
              </div>
              <div>
                MADDE 3- SÖZLEŞME KONUSU ÜRÜN, ÖDEME VE TESLİMATA İLİŞKİN
                BİLGİLER
              </div>
              <div>
                3.1- Sözleşme konusu mal veya hizmetin adı, adeti, KDV dahil
                satış fiyatı, ödeme şekli ve temel nitelikleri
              </div>
              <div>
              ...
              <div>
                <div>
                  ...
                  gereğince faiz ve temerrüt faizi ile ilgili hükümlerin Banka
                  ve TÜKETİCİ arasındaki kredi kartı sözleşmesi kapsamında
                  uygulanacağını kabul, beyan ve taahhüt eder.
                </div>
                <div>
                  Ayrıca, Kredili satış imkanının Bankalar tarafından sadece
                  Banka Müşterisi olan TÜKETİCİ&apos;ye sağlanması nedeniyle,
                  TÜKETİCİ, ilgili faiz oranlarını ve temerrüt faizi ile ilgili
                  bilgileri bankasından ayrıca teyit edeceğini, yürürlükte
                  bulunan mevzuat hükümleri gereğince faiz ve temerrüt faizi ile
                  ilgili hükümlerin Banka ve TÜKETİCİ arasındaki Anında/Mesafeli
                  Alışveriş Kredisi sözleşmesi kapsamında uygulanacağını kabul,
                  beyan ve taahhüt eder. Kredi verme ve detaylı ödeme planınızın
              ...
              <div className="space-y-2">
                ...
                <div>
                  ...
                  kredi kartına iadesi durumunda, konuya müdahil tarafların
                  mağdur duruma düşmemesi için talep edilen iade tutarları, yine
                  taksitli olarak hamil taraf hesaplarına Banka tarafından
                  aktarılır. TÜKETİCİ&apos;nin satış iptaline kadar ödemiş
                  olduğu taksit tutarları, eğer iade tarihi ile kartın hesap
                  kesim tarihleri çakışmazsa her ay karta 1 (bir) iade
                  yansıyacak ve TÜKETİCİ iade öncesinde ödemiş olduğu taksitleri
                  satışın taksitleri bittikten sonra, iade öncesinde ödemiş
                  olduğu taksitleri sayısı kadar ay daha alacak ve mevcut
                  borçlarından düşmüş olacaktır. Kart ile alınmış mal ve
                  hizmetin iadesi durumunda SATICI, Banka ile yapmış olduğu
                  ...
                  yukarıda anlatmış olduğumuz prosedür gereğince
                  TÜKETİCİ&apos;ye nakit olarak ödeme yapılamamaktadır. Kredi
                  kartına iade, SATICI&apos;nın Banka&apos;ya bedeli tek seferde
                  ödemesinden sonra, Banka tarafından yukarıdaki prosedür
              ...
              <div className="space-y-2">
                ...
                <div>
                  ...
                  TÜKETİCİ&apos;nin belirttiği hesaba (hesabın fatura
                  adresindeki kişinin adına veya kullanıcı üyenin adına olması
                  şarttır) havale ve EFT şeklinde yapılacaktır. SATICI bankaya
                  ürün bedelinin tamamını tek seferde geri öder. Havale/EFT
                  yoluyla alınmış mal ve hizmetin iadesi durumunda SATICI, Banka
                  ile yapmış olduğu sözleşme gereği TÜKETİCİ&apos;ye nakit para
                  ile ödeme yapamaz. SATICI, bir iade işlemi söz konusu
                  olduğunda ilgili yazılım aracılığı ile iadesini yapacak olup,
                  SATICI ilgili tutarı Banka&apos;ya nakden veya mahsuben
                  ödemekle yükümlü olduğundan yukarıda anlatmış olduğumuz
                  prosedür gereğince TÜKETİCİ&apos;ye nakit olarak ödeme
                  yapılamamaktadır. TÜKETİCİ, bu prosedürü okuduğunu ve kabul
              ...
              <div className="space-y-2">
                ...
                <div>
                  ...
                  gereğince TÜKETİCİ&apos;ye nakit olarak ödeme
                  yapılamamaktadır. TÜKETİCİ, bu prosedürü okuduğunu ve kabul
                  ettiğini kabul ve taahhüt eder.
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div>
                  Teslim anında TÜKETİCİ&apos;nin adresinde bulunmaması
                  durumunda dahi Firmamız edimini tam ve eksiksiz olarak yerine
                  getirmiş olarak kabul edilecektir.
                </div>
                <div>
              ...
              <div className="space-y-2">
                <div>
                  ...
                  Sözleşmesi&apos;nden 14 (ondört) gün içinde herhangi bir
                  gerekçe göstermeksizin ve cezai şart ödemeksizin cayma hakkına
                  sahiptir.
                </div>
                <div>
                ...
                <div>
                  ...
                  ise TÜKETİCİ&apos;nin veya TÜKETİCİ tarafından belirlenen
                  üçüncü kişinin malı teslim aldığı gün başlar.
                </div>
                <div>
                  Ancak TÜKETİCİ, sözleşmenin kurulmasından malın teslimine
                  kadar olan süre içinde de cayma hakkını kullanabilir. Cayma
                  hakkı süresinin belirlenmesinde;
                </div>
              </div>
              <div className="space-y-3">
                ...
                <ul>
                  b) Birden fazla parçadan oluşan mallarda, TÜKETİCİ&apos;nin
                  veya TÜKETİCİ tarafından belirlenen üçüncü kişinin son parçayı
                  teslim aldığı gün,
                </ul>
                <ul>
                  ...
                  İnternet Sitesi&apos;nde yer alan kişisel üyelik sayfanızdaki
                  kolay iade seçeneği üzerinden gerçekleştirebilirsiniz. Cayma
                  hakkınız kapsamında öngörülen taşıyıcı sipariş edilen ürünün
                  tarafınıza teslim edildiği kargo firması olup, İnternet
                  Sitesi&apos;nde yer alan kişisel üyelik sayfanızdaki kolay
                  iade seçeneğinde geri gönderime ilişkin detaylar
                  açıklanmıştır.
                </ul>
              </div>
              <div className="space-y-3">
                ...
                <ul>
                  ...
                  değişen ve SATICI veya sağlayıcının kontrolünde olmayan mal
                ...
                <ul>
                  ...
                  TÜKETİCİ&apos;ye anında teslim edilen gayrimaddi mallara
                  ilişkin sözleşmeler.
                </ul>
                <ul>
                  h) Cayma hakkı süresi sona ermeden önce, TÜKETİCİ&apos;nin
                  onayı ile ifasına başlanan hizmetlere ilişkin sözleşmeler.
                </ul>
              </div>
              <div>MADDE 5- GENEL HÜKÜMLER</div>
              <div>
                5.1- TÜKETİCİ, www.gonenkleopatra.com internet sitesinde
                sözleşme konusu ürüne ilişkin ön bilgileri okuyup bilgi sahibi
              ...
              <div>
                5.3- Toplu sayılacak siparişlerde SATICI sizinle iletişime
                geçmesi gerekir.
              </div>
              <div>
              ...
              <div>
                ...
                bedelinin TÜKETİCİ&apos;nin tercih ettiği ödeme şekli ile
                ödenmiş olması şarttır. Herhangi bir nedenle ürün bedeli ödenmez
                veya banka kayıtlarında iptal edilir ise, SATICI ürünün teslimi
                yükümlülüğünden kurtulmuş kabul edilir.
              </div>
              <div>
                5.6- Ürünün tesliminden sonra TÜKETİCİ&apos;ya ait kredi
                kartının TÜKETİCİ&apos;nin kusurundan kaynaklanmayan bir şekilde
                ...
                SATICI&apos;ya ödememesi halinde, TÜKETİCİ&apos;nin kendisine
                teslim edilmiş olması kaydıyla ürünün SATICI&apos;ya
              ...
              <div>
                ...
                ödenecektir. Bu satışlar, resmi merciler nezdinde resmi
                işlemlerin yerine getirilmesi ile tamamlanmış sayılacaktır. Bu
                kapsamda cayma hakkı, kargo / teslimat ve benzeri nitelikteki
                uygulama alanı bulunmayan hükümler bu ürünler için geçerli
                olmayacaktır.
              </div>
              <div>MADDE 6- UYUŞMAZLIK VE YETKİLİ MAHKEME</div>
              <div>
                <div>
                  İşbu sözleşme ile ilgili çıkacak ihtilaflarda; Türk
                  Mahkemeleri yetkili olup; uygulanacak hukuk Türk
                  Hukuku&apos;dur.
                </div>
                <div>
                  Türkiye Cumhuriyeti sınırları içerisinde geçerli olmak üzere
                  her yıl Ticaret Bakanlığı tarafından ilan edilen değere kadar
                  olan ihtilaflar için TÜKETİCİ işleminin yapıldığı veya
                  TÜKETİCİ ikametgahının bulunduğu yerdeki İl veya İlçe Tüketici
                  Hakem Heyetleri,söz konusu değerin üzerindeki ihtilaflarda ise
                  TÜKETİCİ işleminin yapıldığı veya TÜKETİCİ ikametgahının
                  bulunduğu yerdeki Tüketici Mahkemeleri Yetkili olacaktır.
                </div>
                <div>
                  Siparişin gerçekleşmesi durumunda TÜKETİCİ işbu sözleşmenin
