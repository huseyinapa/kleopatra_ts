    ...
    <footer className="footer p-10 text-base-content bg-[#ebcfe4]">
      ...
      <nav>
        ...
        <div className="grid grid-flow-col gap-4">
          <a href="https://instagram.com/gonenkleopatra32/" target="_blank" rel="noopener noreferrer">
            <svg
          ...
          <a href="https://api.whatsapp.com/send?phone=905439485180" target="_blank" rel="noopener noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <a href="https://www.tiktok.com/@gonenkleopatra" target="_blank" rel="noopener noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
